		...
		<form method="post" name="adminForm" id="adminForm" action="<?php echo JRoute::_('index.php?option=com_mijovideos&view=channels'.$this->Itemid); ?>">
            <div class="mijovideos_subheader">
                <div class="mijovideos_flow_select">
                    ...
                    <a class="<?php echo MijoVideos::getButtonClass(); ?> <?php echo $grid; ?>" href="<?php echo JRoute::_('index.php?option=com_mijovideos&view=channels&display=grid'.$this->Itemid); ?>" class="v-detail" title="<?php echo JText::_('COM_MIJOVIDEOS_GRID'); ?>"><?php echo JText::_('COM_MIJOVIDEOS_GRID'); ?></a>
                    <a class="<?php echo MijoVideos::getButtonClass(); ?> <?php echo $list; ?>" href="<?php echo JRoute::_('index.php?option=com_mijovideos&view=channels&display=list'.$this->Itemid); ?>" class="v-list" title="<?php echo JText::_('COM_MIJOVIDEOS_LIST'); ?>"><?php echo JText::_('COM_MIJOVIDEOS_LIST'); ?></a>
                </div>
