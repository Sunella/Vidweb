...
class plgMijovideosYoutube extends MijovideosRemote {
    ...
    public function getPlayer(&$output, $pluginParams, $item) {
        ...
        if ($params->get('play_local') == 1) {
            $plugin = MijoVideos::getPlugin($config->get('video_player'));
            ...
            JFactory::getDocument()->addScript(JUri::root() . 'plugins/mijovideos/videojs/video-js/media.youtube.js');
            ...
            JFactory::getDocument()->addStyleDeclaration('.vjs-youtube .vjs-poster { background-size: cover; }
