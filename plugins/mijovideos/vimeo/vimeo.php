...
class plgMijovideosVimeo extends MijovideosRemote {
    ...
    public function getPlayer(&$output, $pluginParams, $item) {
        if (JRequest::getString('view') == 'video' and JRequest::getInt('playlist_id', 0) > 0) {
            $document = JFactory::getDocument();
            $document->addStyleSheet(JUri::root() . 'components/com_mijovideos/assets/css/playlist_vimeo.css');
        }
        ...
        ?>
        <iframe
            src="<?php echo JURI::getInstance()->getScheme(); ?>://player.vimeo.com/video/<?php echo $id; ?>?title=0&amp;autoplay=<?php echo $autoplay; ?>&amp;byline=0&amp;portrait=0"
