CREATE TABLE IF NOT EXISTS `#__mijovideos_categories` (
...
INSERT IGNORE INTO `#__mijovideos_categories` (`id`, `parent`, `title`, `alias`, `description`, `thumb`, `introtext`, `fulltext`, `ordering`, `access`, `language`, `created`, `modified`, `type`, `meta_desc`, `meta_key`, `meta_author`, `published`)
VALUES
  (1, '0', 'Uncategorised', 'uncategorised', NULL, '', '', NULL, '1', '1', '*', NOW(), NOW(), NULL, NULL, NULL, NULL, '1'),
  (2, '0', 'Technology', 'technology', NULL, 'technology.jpg',
   'This category is created by MijoVideos as sample data,you can change or delete it.',
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_channels` (
  `id`           INT(11)    NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_fields` (
  `id`             INT(11)             NOT NULL AUTO_INCREMENT,
...
INSERT IGNORE INTO `#__mijovideos_fields` (`id`, `name`, `title`, `description`, `field_type`, `values`, `default_values`, `display_in`, `rows`, `cols`, `size`, `css_class`, `field_mapping`, `ordering`, `access`, `language`, `published`)
VALUES
  (13, 'mijo_license', 'License', '', 'text', '', '', 2, 0, 0, 25, 'inputbox', '', 13, 1, '*', 1);

CREATE TABLE IF NOT EXISTS `#__mijovideos_files` (
  `id`           INT(11)                 NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_likes` (
  `id`         INT(11)      NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_playlists` (
  `id`            INT(11)    NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_playlist_videos` (
  `id`          INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_report_reasons` (
  `id`          INT(11)             NOT NULL AUTO_INCREMENT,
  `parent`      INT(11) DEFAULT NULL,
  `title`       VARCHAR(255) DEFAULT NULL,
  `alias`       VARCHAR(255) DEFAULT NULL,
...
INSERT IGNORE INTO `#__mijovideos_report_reasons` (`id`, `parent`, `title`, `alias`, `description`, `access`, `language`, `association`, `published`, `created`, `modified`)
VALUES
  (1, NULL, 'Child Abuse', '',
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_reports` (
  `id`         INT(11)          NOT NULL AUTO_INCREMENT,
  `channel_id` INT(11)          NULL,
  `user_id`    INT(11)          NULL,
  `item_id`    INT(11)          NULL,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_processes` (
  `id`               INT(11)    NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_process_type` (
  `id`        INT(11)    NOT NULL AUTO_INCREMENT,
  `title`     VARCHAR(255) DEFAULT NULL,
  `alias`     VARCHAR(255) DEFAULT NULL,
...
INSERT IGNORE INTO `#__mijovideos_process_type` (`id`, `title`, `alias`, `filetype`, `size`, `ordering`, `published`)
VALUES
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_subscriptions` (
  `id`         INT(11)          NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_videos` (
  `id`          INT(11)             NOT NULL AUTO_INCREMENT,
  `user_id`     INT(11)             NOT NULL DEFAULT '0',
  `channel_id`  INT(11)             NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `#__mijovideos_video_categories` (
  `id`          INT(11) NOT NULL AUTO_INCREMENT,
  `video_id`    INT(11) NULL,
