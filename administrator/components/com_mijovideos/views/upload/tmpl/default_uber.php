...
<?php if(JRequest::getWord('task') == 'edit' and JRequest::getWord('view') == 'videos') {
        ...
        <?php if ($_CONFIG['show_percent_complete'] || $_CONFIG['show_files_uploaded'] || $_CONFIG['show_current_position'] || $_CONFIG['show_elapsed_time'] || $_CONFIG['show_est_time_left'] || $_CONFIG['show_est_speed']) { ?>
            ...
            <table class="adminlist" style="width: 50%;">
                ...
                <?php if ($_CONFIG['show_percent_complete']) { ?>
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_PERCENT_COMPLETE'); ?>
                        </th>
                        <td class="center">
                ...
                <?php if ($_CONFIG['show_files_uploaded']) { ?>
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_FILES_UPLOADED'); ?>
                        </th>
                        <td class="center">
                ...
                <?php if ($_CONFIG['show_current_position']) {
                    ...
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_CURRENT_POSITION'); ?>
                        </th>
                        <td class="center">
                ...
                <?php if ($_CONFIG['show_current_position']) { ?>
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_ELAPSED_TIME'); ?>
                        </th>
                        <td class="center">
                            <span id="time">0</span>
                        </td>
                ...
                <?php if ($_CONFIG['show_est_time_left']) { ?>
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_EST_TIME_LEFT'); ?>
                        </th>
                        <td class="center">
                ...
                <?php if ($_CONFIG['show_est_time_left']) { ?>
                    <tr>
                        <th scope="row">
                            <?php echo JText::_('COM_MIJOVIDEOS_EST_SPEED'); ?>
                        </th>
                        <td class="center">
...
<?php if (JFactory::getApplication()->isAdmin()) : ?>
    <fieldset class="adminform">
        <ul class="panelform">
            <li>
                <label><?php echo JText::_('COM_MIJOVIDEOS_SUPPORTED_FORMATS_LABEL'); ?></label>
    ...
    <fieldset class="adminform">
        <ul class="panelform">
            <noscript><p><?php echo JText::_('COM_MIJOVIDEOS_PLEASE_ENABLE_JAVASCRIPT'); ?></p></noscript>
            <div id="upload_slots">
                <li>
                    <label><?php echo JText::_('COM_MIJOVIDEOS_UPLOAD_A_FILE'); ?></label>
            ...
            <li>
                <label></label>
                <button class="btn" type="button" id="upload_button" name="upload_button" value="Upload"
                        onClick="linkUpload();">
...
<?php else : ?>
    ...
    <fieldset class="adminform">
        ...
        <div class="formelm-buttons">
            <button class="mijovideos_button" type="button" id="upload_button" name="upload_button" value="Upload"
                    onClick="linkUpload();">
                <?php echo JText::_('COM_MIJOVIDEOS_UPLOAD') ?>
            </button>
        </div>
