...
class MijovideosModelCategories extends MijovideosModel {
    ...
    public function _buildViewQuery() {
        ...
        $this->_query = 'SELECT c.*, c.parent AS parent_id, c.title AS title, COUNT(vc.id) AS total_videos '.
                        ...
                        'LEFT JOIN #__mijovideos_video_categories AS vc '.
    ...
    public function getItems() {
		if (empty($this->_data)) {
			...
			$list = JHtml::_('menu.treerecurse', $this->filter_parent, '', array(), $children, 9999);
