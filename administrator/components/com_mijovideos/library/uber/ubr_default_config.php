...
if ($is_admin) {
    $redirect_url = JUri::root() . 'administrator/index.php?option=com_mijovideos&amp;view=upload&amp;task=uberupload';
} else {
    $redirect_url = JUri::root() . 'index.php?option=com_mijovideos&amp;view=upload&amp;task=uberupload';
}

$_CONFIG['config_file_name']                      = 'ubr_default_config';
$_CONFIG['upload_dir']                            = JPATH_ROOT . '/media/com_mijovideos/videos/';
