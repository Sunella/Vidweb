...
$is_dashboard = (MijoVideos::isDashboard() ? '&dashboard=1' : '');
...
$PATH_TO_LINK_SCRIPT         = JUri::root(true) . '/administrator/index.php?option=com_mijovideos&view=upload&task=link_upload&format=raw'.$is_dashboard;        // Path info //JUri::root( true ).'/administrator/components/com_mijovideos/library/uber/ubr_link_upload.php';
$PATH_TO_SET_PROGRESS_SCRIPT = JUri::root(true) . '/administrator/index.php?option=com_mijovideos&view=upload&task=set_progress&format=raw'.$is_dashboard;       // Path info
$PATH_TO_GET_PROGRESS_SCRIPT = JUri::root(true) . '/administrator/index.php?option=com_mijovideos&view=upload&task=get_progress&format=raw'.$is_dashboard;       // Path info
$PATH_TO_JS_SCRIPT           = JUri::root() . 'components/com_mijovideos/assets/js/ubr_file_upload.js';             // Path info
